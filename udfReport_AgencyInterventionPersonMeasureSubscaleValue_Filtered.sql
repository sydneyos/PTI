...
/****** Object:  UserDefinedFunction [dbo].[udfReport_AgencyInterventionPersonMeasureSubscaleValue_Filtered]    Script Date: 8/18/2013 10:04:32 AM ******/
DROP FUNCTION [dbo].[udfReport_AgencyInterventionPersonMeasureSubscaleValue_Filtered]
GO
...
-- Description:	
-- =============================================
CREATE FUNCTION [dbo].[udfReport_AgencyInterventionPersonMeasureSubscaleValue_Filtered]
(	
	@AgencyID						int = NULL,
