...
--		(
			...
			ORDER BY MeasureTypeID, MeasureSubscaleTypeID, RespondentPersonID, AssessedPersonID, ScoreTypeID, OcassionTypeID
--			) AS I
--		GROUP BY 
--		InterventionID
--		, MeasureTypeID 
...
--			AND (FormInstanceMeasureSubscaleValueID IS NOT NULL)
